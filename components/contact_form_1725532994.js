<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Score Big with Your Cricket App Idea</h3>
        <p class="mt-3 text-black w-fit">Let's build the next game-changing cricket mobile app together</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Your Cricket App Concept</label>
        ...
        <div>
          <label class="font-medium text-black">Preferred Development Timeline</label>
          <textarea
            required
